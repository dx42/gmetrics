...
class MethodResultsNodeTest extends AbstractTestCase {
    ...
    private static final MetricResult METRIC_RESULT1 = new SingleNumberMetricResult(METRIC, MetricLevel.METHOD, 1)
    private static final MetricResult METRIC_RESULT2 = new SingleNumberMetricResult(METRIC, MetricLevel.METHOD, 2)
    private static final MetricResult METRIC_RESULT3 = new SingleNumberMetricResult(METRIC, MetricLevel.METHOD, 3)

    private MethodResultsNode methodResultsNode = new MethodResultsNode(NAME)
