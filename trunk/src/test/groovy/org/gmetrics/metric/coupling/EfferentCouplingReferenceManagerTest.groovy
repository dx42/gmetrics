...
class EfferentCouplingReferenceManagerTest extends AbstractTestCase {
    ...
    void testUpdateStatisticsForAllPackages_UpdatesStatisticsForSingleReferencedPackage() {
        ...
        assertMetricResult(manager.getPackageMetricResult(null), [referencedPackages:[], count:1, value:0, total:1, average:1])
    }
    ...
    void testUpdateStatisticsForAllPackages_UpdatesForAncestorPackages() {
        ...
        assertMetricResult(manager.getPackageMetricResult(null), [count:1, value:0, total:2, average:2, referencedPackages:[]])
    }
    ...
    void testAddReferencesFromPackage_IncrementsTotalForSharedAncestorPackages() {
        ...
        manager.addReferencesFromPackage('aa.dd', [PACKAGE2, PACKAGE3])
        manager.updateStatisticsForAllPackages()
        ...
        assertMetricResult(manager.getPackageMetricResult('aa.dd'), [count:1, value:2, total:2, average:2, referencedPackages:[PACKAGE2, PACKAGE3]])
